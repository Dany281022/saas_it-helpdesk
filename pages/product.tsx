...
// Subscription gate — shown to users without an active Premium plan
...
export default function Product() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 pt-10 pb-20">
      ...
      {/*
        SUBSCRIPTION GATE — Production implementation:
        ...
        NOTE: Clerk Billing requires a custom domain for Production instances
        and does not function on vercel.app subdomains. The gate is bypassed
        here to allow end-to-end testing. PricingTable and Protect are fully
        implemented above and were tested in the development environment.
      */}
